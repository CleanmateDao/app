...
export default function SubmitProofOfWork() {
  ...
  const allParticipantsRated = acceptedParticipants.every(
    (p) =>
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const ratingsData: ParticipantRating[] = acceptedParticipants.map(
        (participant) => {
  ...
  const mediaProgress = Math.min(
    (proofMedia.length / MIN_MEDIA_COUNT) * 100,
    100
  );
      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upload at least {MIN_MEDIA_COUNT} images or videos as proof of the
              cleanup work
            </CardDescription>
          </CardHeader>
            ...
            {proofMedia.length > 0 && proofMedia.length < MIN_MEDIA_COUNT && (
              <div className="flex items-center gap-2 p-3 bg-primary/10 border border-primary/20 rounded-lg">
                ...
                <p className="text-sm text-primary">
                  Please upload {MIN_MEDIA_COUNT - proofMedia.length} more
                  file(s) to meet the minimum requirement
                </p>
              </div>
            )}
          </CardContent>
      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Rate each participant from 0 to 5 stars based on their
              contribution
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <div className="flex-1 text-sm">
                <div className="flex items-center gap-4">
                  ...
                  >
                    {hasEnoughMedia ? "✓" : "○"} {proofMedia.length}/
                    {MIN_MEDIA_COUNT} media
                  </div>
                  <div
                    className={
              ...
              <div className="w-full sm:w-auto space-y-2">
                ...
                <Button
                  ...
                  disabled={
                    !hasEnoughMedia || !allParticipantsRated || isSubmitting
                  }
      ...
      <div className="flex items-center gap-1">
        {[0, 1, 2, 3, 4, 5].map((star) => (
          <button
            ...
            title={
              star === 0 ? "No rating" : `${star} star${star > 1 ? "s" : ""}`
            }
          >
            {star === 0 ? (
              <div
